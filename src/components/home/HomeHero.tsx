  ...
  return (
    <section className="px-6 py-20 text-center text-teal-300 bg-zinc-800">
      ...
      <div className="flex justify-center gap-4">
        <Link href="/chatroom" className="px-6 py-2 text-sm font-medium text-white bg-teal-600 shadow rounded-xl hover:bg-teal-700">Try as Guest</Link>
        <Link href="/auth/register" className="px-6 py-2 text-sm font-medium text-white border rounded-xl border-zinc-600 bg-zinc-700 hover:bg-zinc-600">
          Sign Up
        </Link>
      </div>
    </section>
